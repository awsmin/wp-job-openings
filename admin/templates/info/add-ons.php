...
<div id="awsm-add-on" class="awsm-job-addon awsm-tab-item">
	...
	<?php endif; ?>
	<p><?php printf( esc_html__( 'More add-ons are being developed by our team. If you have any suggestions or feature request, please feel free to reach us through %s our website %s. ' ), '<a href="https://awsm.in/support/" target="_blank">', '</a>' ); ?></p>
</div><!-- .awsm-job-addon -->