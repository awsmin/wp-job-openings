	...
	<div class="awsm-row awsm-help-main">
		<div class="awsm-col awsm-help-left">
			...
			<div class="awsm-help-section">
				...
				<p><?php printf( esc_html__( 'We are just getting started. Any suggestions you may have would help us to build this plugin to a powerful recruiting tool for your company. Please share your suggestions and feature requests through %1$s our website %2$s. ' ), '<a href="https://awsm.in/contact/" target="_blank">', '</a>' ); ?></p>
			</div><!-- .awsm-help-section -->
			<div class="awsm-help-section">
