...
jQuery(function ($) {
  ...
  */
  ...
  $(filterSelector + ' .awsm-b-filter-option').on('change', function (e) {
    ...
    var firstOption = allOptions.eq(0); // "All"
    var selectedOptions = allOptions.filter(':selected');
    ...
    ---------------------------------------------------- */
    var wasAllSelected = $elem.data('was-all-selected') === true;
    var isAllSelected = firstOption.is(':selected');
