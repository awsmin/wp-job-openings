...
if ( $placement === 'top' ) {
	...
	?>
			...
			<?php if ( $show_filter ) { ?>
					...
					?>
					<div class="awsm-b-filter-wrap<?php echo ! $has_search ? ' awsm-b-no-search-filter-wrap' : ''; ?><?php echo esc_attr( $filter_wrap_loading_class ); ?><?php echo class_exists( 'AWSM_Job_Openings_Alert_Main_Blocks' ) ? ' awsm-jobs-alerts-on' : ''; ?>" data-placement="side">
						<?php
						/**
