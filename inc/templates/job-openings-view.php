...
if (
	...
	( ! empty( $shortcode_atts['sort'] ) && $shortcode_atts['sort'] === 'enable' )
) { 
	$show_filter = true;

	// Only assign 'awsm-job-2-col' if sort is NOT enabled
	$placement_sidebar_class = ( ! empty( $shortcode_atts['sort'] ) && $shortcode_atts['sort'] === 'enable' ) ? null : 'awsm-job-2-col';
}
